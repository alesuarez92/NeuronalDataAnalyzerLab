    ...
    methods(Static)
        ...
        function t = topicEEGAnalysis()
            ...
            t.inputs = {
                ...
                'BrainVision .vhdr (Brain Products Recorder or Analyzer, and exports from EEGLAB / MNE), read together with its .vmrk and .eeg files in the same folder: continuous recordings with their markers (S 1, R 2, ...) or segments exported from Analyzer (the condition of each segment is its marker at time 0), channel names, positions, units and the amplifier filters used when recording'
