...
classdef SignalCharacterizationApp < handle
    ...
    methods
        ...
        function buildUI(app)
            ...
            uilabel(app.HeaderPanel, 'Text', 'Signal Characterization', ...
                'Position', [T.headerPaddingH 22 400 26], ...
                'FontSize', T.fontTitle, 'FontWeight', 'bold', 'FontColor', T.headerTitleColor);
            uilabel(app.HeaderPanel, 'Text', 'Extract response features from processed data', ...
                'Position', [T.headerPaddingH 6 380 18], ...
                'FontSize', T.fontSubtitle, 'FontColor', T.headerSubtitleColor);
            uibutton(app.HeaderPanel, 'push', 'Text', 'Help', ...
                'Position', [820 14 72 32], ...
